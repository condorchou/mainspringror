...
#role :web, "orion.ocssolutions.com" # "your web-server here"                          # Your HTTP server, Apache/etc
#role :app, "orion.ocssolutions.com" #"your app-server here"                          # This may be the same as your `Web` server
#role :db,  "orion.ocssolutions.com" #"your primary db-server here", :primary => true # This is where Rails migrations will run
...
set :deploy_to, "/home/mainspri/rails_apps/mainspring"
#set :user, "meatteam"
